...
server.listen(6655, function() {
    console.log((new Date()) + ' Server is listening on port 6655');
});
...
wsServer.on('request', function(request) {
    ...
    connection.id = wsServer.connections.length;
...
//              if (wsServer.connections[i].id != i) {
                wsServer.connections[i].sendUTF(message.utf8Data);
//              }
            }
        }
